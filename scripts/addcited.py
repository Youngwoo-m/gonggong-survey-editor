...
규정(3종)이 부르는데 라이브러리에 없어 '확인필요' 로 남던 것들이다 —
...
NEW = [
    ...
    # 고압가스배관ㆍ부속시설의 위임 사슬을 따라갈 수 있게 — 법은 이미 있고
    # 시행령ㆍ시행규칙이 없어 제52조의7(안전조치 등)을 확인할 수 없었다
    ("고압가스 안전관리법 시행령", "고압가스 안전관리법 시행령", "under", "law"),
    ("고압가스 안전관리법 시행규칙", "고압가스 안전관리법 시행규칙", "under", "law"),
]
