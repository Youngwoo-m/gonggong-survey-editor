...
import { revLabel, nextRevLabel, revValue, verPrefixOf } from "./targets.js?v=20260824a";
import { regFingerprint } from "./xrefs.js?v=20260824a";
import { numbersOf, planFrom, planStayed, remapCitations, articleIdsIn,
         planTermFixes, TERM_RULES } from "./xrefs.js?v=20260824a";
