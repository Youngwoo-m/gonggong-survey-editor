...
import { revLabel, nextRevLabel, revValue, verPrefixOf } from "./targets.js?v=20260904n";
import { regFingerprint } from "./xrefs.js?v=20260904n";
import { numbersOf, planFrom, planStayed, remapCitations, articleIdsIn,
         planTermFixes, TERM_RULES } from "./xrefs.js?v=20260904n";
