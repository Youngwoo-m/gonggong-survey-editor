...
import { revLabel, nextRevLabel, revValue, verPrefixOf } from "./targets.js?v=20260824d";
import { regFingerprint } from "./xrefs.js?v=20260824d";
import { numbersOf, planFrom, planStayed, remapCitations, articleIdsIn,
         planTermFixes, TERM_RULES } from "./xrefs.js?v=20260824d";
