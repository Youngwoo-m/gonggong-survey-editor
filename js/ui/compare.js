/* ============================================================
   ...
   ============================================================ */
import { buildComparison, KIND_LIST, kindLabel } from "../core/diff.js?v=20260906t";
import { writeXlsx } from "../core/xlsx.js?v=20260906t";
import * as M from "../core/model.js?v=20260906t";
import { regFingerprint } from "../core/xrefs.js?v=20260906t";
import { buildAmendment } from "../core/amend.js?v=20260906t";
import { buildSupplement, EFFECT_KINDS, topTitles } from "../core/supplement.js?v=20260906t";
import { stripImgTags, imgIdsIn, toHtml, fitTable }
  from "../core/objects.js?v=20260906t";
import { esc, fmtDate } from "./html.js?v=20260906t";
...
<tbody>${body}</tbody></table></html>`;
  ...
  async exportHwpx(btn) {
    ...
    try {
      const { buildCompareHwpx } = await import("../core/hwpxcompare.js?v=20260906t");
