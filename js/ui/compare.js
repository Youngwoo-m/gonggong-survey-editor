...
import { regFingerprint } from "../core/xrefs.js?v=20260907s";
import { buildAmendment } from "../core/amend.js?v=20260907s";
import { buildSupplement, EFFECT_KINDS, topTitles } from "../core/supplement.js?v=20260907s";
...
<tbody>${body}</tbody></table></html>`;
  ...
  async exportHwpx(btn) {
    ...
    try {
      const { buildCompareHwpx } = await import("../core/hwpxcompare.js?v=20260907s");
