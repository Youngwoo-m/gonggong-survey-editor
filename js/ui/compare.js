/* ============================================================
   ...
   ============================================================ */
import { buildComparison, KIND_LIST, kindLabel } from "../core/diff.js?v=20260907z";
import { writeXlsx } from "../core/xlsx.js?v=20260907z";
import * as M from "../core/model.js?v=20260907z";
import { regFingerprint } from "../core/xrefs.js?v=20260907z";
import { buildAmendment } from "../core/amend.js?v=20260907z";
import { buildSupplement, EFFECT_KINDS, topTitles } from "../core/supplement.js?v=20260907z";
import { stripImgTags, imgIdsIn, toHtml, fitTable }
  from "../core/objects.js?v=20260907z";
import { esc, fmtDate } from "./html.js?v=20260907z";
...
<tbody>${body}</tbody></table></html>`;
  ...
  async exportHwpx(btn) {
    ...
    try {
      const { buildCompareHwpx } = await import("../core/hwpxcompare.js?v=20260907z");
