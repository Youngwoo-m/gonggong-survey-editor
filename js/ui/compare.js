/* ============================================================
   ...
   ============================================================ */
import { buildComparison, KIND_LIST, kindLabel } from "../core/diff.js?v=20260906n";
import { writeXlsx } from "../core/xlsx.js?v=20260906n";
import * as M from "../core/model.js?v=20260906n";
import { regFingerprint } from "../core/xrefs.js?v=20260906n";
import { buildAmendment } from "../core/amend.js?v=20260906n";
import { buildSupplement, EFFECT_KINDS, topTitles } from "../core/supplement.js?v=20260906n";
import { stripImgTags, imgIdsIn, toHtml, fitTable }
  from "../core/objects.js?v=20260906n";
import { esc, fmtDate } from "./html.js?v=20260906n";
...
<tbody>${body}</tbody></table></html>`;
  ...
  async exportHwpx(btn) {
    ...
    try {
      const { buildCompareHwpx } = await import("../core/hwpxcompare.js?v=20260906n");
