...
import { wordDiff, beforeRuns, afterRuns, hasChange } from "../core/textdiff.js?v=20260907u";
import { imgIdsIn, renderBody, fitTable, toHtml, openTableOverlay, markAnnexEdits }
  from "../core/objects.js?v=20260907u";

/** 만들고 있는 안을 부르는 말 — 작업규정은 개정안, 성과심사 규정은 개정안 */
/* 만들어 내는 안을 부르는 말 — 규정마다 다르다 (작업규정은 '개정안', 나머지는 '개정안').
   편집기를 합치면서 화면 하나가 규정(3종)을 오가므로, 손대는 규정이 바뀔 때 갈아 끼운다. */
let WORD = "개정안";
...
import { linkReason, wireReasonLinks } from "../core/reasonlink.js?v=20260907u";
import { esc, fmtDT } from "./html.js?v=20260907u";
import { renderPdf } from "./pdfview.js?v=20260907u";
import { askYesNo } from "./ask.js?v=20260907u";
    ...
    (async () => {
      try {
        const [{ annexXmlFromHwpx, assetBuffer }, { parseXml }] = await Promise.all([
          import("../core/annexhwpx.js?v=20260907u"),
          import("../core/objects.js?v=20260907u"),
        ]);
