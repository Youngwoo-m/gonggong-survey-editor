...
import { wordDiff, beforeRuns, afterRuns, hasChange } from "../core/textdiff.js?v=20260907z";
...
import { linkReason, wireReasonLinks } from "../core/reasonlink.js?v=20260907z";
import { esc, fmtDT } from "./html.js?v=20260907z";
import { renderPdf } from "./pdfview.js?v=20260907z";
import { askYesNo } from "./ask.js?v=20260907z";
    ...
    (async () => {
      try {
        const [{ annexXmlFromHwpx, assetBuffer }, { parseXml }] = await Promise.all([
          import("../core/annexhwpx.js?v=20260907z"),
          import("../core/objects.js?v=20260907z"),
        ]);
